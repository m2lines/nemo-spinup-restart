...
def main():
    ...
    parser = argparse.ArgumentParser(description="Update NEMO restart files with ML predictions")
    parser.add_argument(
        "--restart_path", type=str, required=True, help="path of restart file directory"
    )
    parser.add_argument("--radical", type=str, required=True, help="radical of restart filename")
    parser.add_argument("--mask_file", type=str, required=True, help="address of mask file")
    parser.add_argument(
        "--prediction_path", type=str, required=True, help="path of prediction directory"
    )
    parser.add_argument(
